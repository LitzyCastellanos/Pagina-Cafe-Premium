      ...
      <div className='mx-auto max-w-7xl px-4 sm:px-6 lg:px-8'>
        ...
        <div className='mx-auto mb-12 flex max-w-3xl flex-col items-center justify-center space-y-4 text-center md:mb-16 lg:mb-24'>
          ...
          <p className='text-muted-foreground text-xl'>
            En Café Premium Copán, cada taza cuenta una historia. Con años de dedicación y pasión por el café de especialidad, hemos transformado el arte del cultivo en una experiencia inolvidable.
          </p>
          <Button
            size='lg'
            asChild
