...
const HeroSection = ({ menudata }: { menudata: MenuData[] }) => {
  ...
  El mejor café de altura de Copán
</h1>

<p className='text-muted-foreground max-w-xl text-xl max-lg:text-center'>
  Granos 100% hondureños, tostado artesanal con notas de chocolate y cítricos. Directo de nuestras fincas a tu taza.
</p>
  ...
  <ArrowRightIcon className='transition-transform duration-200 group-hover:translate-x-0.5' />
              ...
              >
<a href='#contacto'>Cotizar Pedido</a>
              </Button>
            </div>
          </div>
